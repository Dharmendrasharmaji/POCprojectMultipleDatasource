...
//Configuring primary datasource
...
@EnableJpaRepositories(
		...
		basePackages = {"com.poc.project.repository.employee"})
public class PrimaryDataSourceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
		...
		return primaryEntityManagerFactoryBuilder
				...
				.packages("com.poc.project.entity.employee")
...
//	Configuring Liquibase for primary datasource
	...
	public SpringLiquibase primaryLiquibase() {
		return springLiquibase(primaryDataSource(primaryDataSourceProperties()), primaryLiquibaseProperties());
	}
